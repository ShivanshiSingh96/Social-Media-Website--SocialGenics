...
import recommendedUserData from './RecommendedUserData.jsx';
            ...
            <div className='w-full h-auto py-3'>
                        ...
                        >
                            <Link to="/profile" className='w-full h-auto flex items-center gap-x-2 '>
                                ...
                                <div className="flex items-start gap-y-0 flex-col">
                                    ...
                                    <h6 className="text-sm text-gray-500 text-normal">Suggested for you</h6>
                                </div>
                            </Link>
                            <Link to="/" className='text-[0.855rem] text-blue-400 hover:text-gray-200'>
                                {user.follow}
                            </Link>
                        </div>
                    ))}
                ...
                <div className="w-full h-auto">
                    <div className="w-full h-auto flex items-center gap-x-[4px] flex-wrap mb-3">
                        {linkData.map((data) => (
                            <div key={data.id} className="w-fit h-auto flex items-center gap-x-[4px]">
                                <Link to="/" className='text-[0.8rem] font-normal text-[#5b5b5b] hover:underline'>
                                    {data.title}
                                </Link>
                    ...
                    <p className='text-sm text-[#5b5b5b] font-normal'>
                        &copy; 2024 SOCIALGENEICS FROM META
                    </p>
                </div>
            </div>
        </>
