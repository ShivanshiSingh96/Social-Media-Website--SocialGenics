...
import FeedData from '../FeedData/FeedData.jsx';
                ...
                <div key={feed.id} className='w-full h-auto mb-6 '>
                    ...
                    <div className='w-full h-auto flex items-center justify-between mb-2 '>
                        <div className='flex items-center gap-x-2 '>
                            ...
                            >
                                <div className='w-10 h-10 rounded-full object-cover p-[2px] bg-gradient-to-r from-yellow-400 to-blue-400 '>
                                    <img 
                                        src={feed.profileImg} 
                                        alt={feed.profileImg} 
                    ...
                    <div className="w-full h-auto flex items-center justify-between border-b border-b-gray-500">
                        <input 
                            type="text" 
                            className="w h-auto bg-transparent border-none outline-none focus:outline-none text-sm text-gray-400 py-3" 
